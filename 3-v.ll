...
define void @_B04rootmain() !dbg !5 {
  ...
  %5 = alloca i8, !dbg !18
  %6 = load i8*, i8** @_bal_stack_guard, !dbg !18
  %7 = icmp ult i8* %5, %6, !dbg !18
  br i1 %7, label %33, label %8, !dbg !18
8:
  %9 = and i64 72057594037927935, 5, !dbg !19
  %10 = or i64 2810246167479189504, %9, !dbg !19
  %11 = getelementptr i8, i8 addrspace(1)* null, i64 %10, !dbg !19
  store i8 addrspace(1)* %11, i8 addrspace(1)** %a, !dbg !19
  ...
  %24 = getelementptr inbounds {{i32, i32, i64, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*, [0 x i64]}*, i64, i64, i8* addrspace(1)*}, {{i32, i32, i64, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*, [0 x i64]}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %23, i64 0, i32 3, !dbg !23
  %25 = load i8* addrspace(1)*, i8* addrspace(1)* addrspace(1)* %24, align 8, !dbg !23
  %26 = bitcast i8* addrspace(1)* %25 to [0 x i8 addrspace(1)*] addrspace(1)*, !dbg !23
  %27 = load i8 addrspace(1)*, i8 addrspace(1)** %b, !dbg !23
  %28 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %26, i64 0, i64 0, !dbg !23
  store i8 addrspace(1)* %27, i8 addrspace(1)* addrspace(1)* %28, !dbg !23
  %29 = getelementptr inbounds {{i32, i32, i64, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*, [0 x i64]}*, i64, i64, i8* addrspace(1)*}, {{i32, i32, i64, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*, [0 x i64]}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %23, i64 0, i32 1, !dbg !23
  store i64 1, i64 addrspace(1)* %29, !dbg !23
  %30 = bitcast {{i32, i32, i64, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*, [0 x i64]}*, i64, i64, i8* addrspace(1)*} addrspace(1)* %23 to i8 addrspace(1)*, !dbg !23
  %31 = getelementptr i8, i8 addrspace(1)* %30, i64 1297036692682702852, !dbg !23
  store i8 addrspace(1)* %31, i8 addrspace(1)** %3, !dbg !23
  %32 = load i8 addrspace(1)*, i8 addrspace(1)** %3, !dbg !24
  call void @_Bb02ioprintln(i8 addrspace(1)* %32), !dbg !24
  store i8 addrspace(1)* null, i8 addrspace(1)** %4, !dbg !24
  ret void, !dbg !25
33:
  %34 = call i8 addrspace(1)* @_bal_panic_construct(i64 516), !dbg !18
  call void @_bal_panic(i8 addrspace(1)* %34), !dbg !18
  unreachable, !dbg !18
}
!llvm.module.flags = !{!0}
!llvm.dbg.cu = !{!2}
...
!12 = distinct !DILexicalBlock(scope: !5, file: !1, line: 3, column: 15)
!13 = !DILocalVariable(name:"a", scope: !12, file: !1, line: 3, type: !11)
!14 = !DILocation(line: 3, column: 15, scope: !12)
!15 = distinct !DILexicalBlock(scope: !12, file: !1, line: 5, column: 15)
!16 = !DILocalVariable(name:"b", scope: !15, file: !1, line: 5, type: !11)
!17 = !DILocation(line: 5, column: 15, scope: !15)
!18 = !DILocation(line: 2, column: 16, scope: !5)
!19 = !DILocation(line: 3, column: 17, scope: !12)
!20 = !DILocation(line: 4, column: 15, scope: !12)
!21 = !DILocation(line: 4, column: 4, scope: !12)
!22 = !DILocation(line: 5, column: 17, scope: !15)
!23 = !DILocation(line: 6, column: 15, scope: !15)
!24 = !DILocation(line: 6, column: 4, scope: !15)
!25 = !DILocation(line: 7, column: 0, scope: !15)
