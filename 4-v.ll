...
define void @_B04rootmain() !dbg !5 {
  ...
  call void @llvm.dbg.declare(metadata i8 addrspace(1)** %c, metadata !17, metadata !8), !dbg !18
  %7 = alloca i8, !dbg !19
  %8 = load i8*, i8** @_bal_stack_guard, !dbg !19
  %9 = icmp ult i8* %7, %8, !dbg !19
  br i1 %9, label %46, label %10, !dbg !19
10:
  %11 = and i64 72057594037927935, 5, !dbg !20
  %12 = or i64 2810246167479189504, %11, !dbg !20
  %13 = getelementptr i8, i8 addrspace(1)* null, i64 %12, !dbg !20
  store i8 addrspace(1)* %13, i8 addrspace(1)** %a, !dbg !20
  ...
  %16 = load i8* addrspace(1)*, i8* addrspace(1)* addrspace(1)* %15, align 8, !dbg !21
  %17 = bitcast i8* addrspace(1)* %16 to [0 x i8 addrspace(1)*] addrspace(1)*, !dbg !21
  %18 = load i8 addrspace(1)*, i8 addrspace(1)** %a, !dbg !21
  %19 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %17, i64 0, i64 0, !dbg !21
  ...
  %24 = call i8 addrspace(1)* @_bal_int_to_tagged(i64 288230376151711744), !dbg !23
  store i8 addrspace(1)* %24, i8 addrspace(1)** %b, !dbg !23
  ...
  %35 = call i8 addrspace(1)* @_bal_float_to_tagged(double 0.5), !dbg !26
  store i8 addrspace(1)* %35, i8 addrspace(1)** %c, !dbg !26
  ...
  %40 = load i8 addrspace(1)*, i8 addrspace(1)** %c, !dbg !27
  %41 = getelementptr inbounds [0 x i8 addrspace(1)*], [0 x i8 addrspace(1)*] addrspace(1)* %39, i64 0, i64 0, !dbg !27
  store i8 addrspace(1)* %40, i8 addrspace(1)* addrspace(1)* %41, !dbg !27
  ...
  store i64 1, i64 addrspace(1)* %42, !dbg !27
  ...
  %44 = getelementptr i8, i8 addrspace(1)* %43, i64 1297036692682702852, !dbg !27
  store i8 addrspace(1)* %44, i8 addrspace(1)** %5, !dbg !27
  %45 = load i8 addrspace(1)*, i8 addrspace(1)** %5, !dbg !28
  call void @_Bb02ioprintln(i8 addrspace(1)* %45), !dbg !28
  store i8 addrspace(1)* null, i8 addrspace(1)** %6, !dbg !28
  ret void, !dbg !29
46:
  %47 = call i8 addrspace(1)* @_bal_panic_construct(i64 516), !dbg !19
  call void @_bal_panic(i8 addrspace(1)* %47), !dbg !19
  unreachable, !dbg !19
}
!llvm.module.flags = !{!0}
!llvm.dbg.cu = !{!2}
...
!23 = !DILocation(line: 5, column: 16, scope: !9)
...
!28 = !DILocation(line: 8, column: 4, scope: !9)
