...
%Type2 = type {i1(%UniformSubtype*, i8 addrspace(1)*)*, i32}
%Type3 = type {i1(%UniformSubtype*, i8 addrspace(1)*)*, i32, [1 x i32]}
@_Bi04root0 = constant {i32, i32, i64, {i32}*, [2 x i64]} {i32 0, i32 2, i64 ptrtoint({i32, i32, [2 x %UniformSubtype*]}* @.member0 to i64), {i32}* null, [2 x i64] [i64 2049, i64 257]}
@.subtype0 = internal constant %Type0 {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_precomputed_subtype_contains, i32 2, [2 x i32] [i32 1, i32 2]}, align 8
...
@_Bi04root2 = constant {i32, i32, i64, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*, [0 x i64]} {i32 1, i32 0, i64 0, i8 addrspace(1)*(i8 addrspace(1)*, i64)* @_bal_list_int_array_get_tagged, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)* @_bal_list_int_array_set_tagged, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)* @_bal_list_int_array_set_tagged, i64(i8 addrspace(1)*, i64)* @_bal_list_int_array_get_int, i64(i8 addrspace(1)*, i64, i64)* @_bal_list_int_array_set_int, i64(i8 addrspace(1)*, i64, i64)* @_bal_list_int_array_set_int, double(i8 addrspace(1)*, i64)* null, i64(i8 addrspace(1)*, i64, double)* @_bal_list_int_array_set_float, i64(i8 addrspace(1)*, i64, double)* @_bal_list_int_array_set_float, i64 257, {i32}* null, [0 x i64] []}
@_Bi04root3 = constant {i32, i32, i64, {i32}*, [3 x i64]} {i32 1, i32 3, i64 1, {i32}* null, [3 x i64] [i64 2049, i64 513, i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member1 to i64)]}
@.subtype2 = internal constant %Type2 {i1(%UniformSubtype*, i8 addrspace(1)*)* @_bal_array_subtype_contains, i32 128}, align 8
@.member1 = internal constant {i32, i32, [1 x %UniformSubtype*]} {i32 0, i32 262144, [1 x %UniformSubtype*] [%UniformSubtype* bitcast(%Type2* @.subtype2 to %UniformSubtype*)]}
@_Bi04root4 = constant {i32, i32, i64, i8 addrspace(1)*(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)*, i64(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, i64)*, i64(i8 addrspace(1)*, i64, i64)*, double(i8 addrspace(1)*, i64)*, i64(i8 addrspace(1)*, i64, double)*, i64(i8 addrspace(1)*, i64, double)*, i64, {i32}*, [0 x i64]} {i32 2, i32 0, i64 0, i8 addrspace(1)*(i8 addrspace(1)*, i64)* @_bal_list_generic_get_tagged, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)* @_bal_list_generic_set_tagged, i64(i8 addrspace(1)*, i64, i8 addrspace(1)*)* @_bal_list_generic_inexact_set_tagged, i64(i8 addrspace(1)*, i64)* @_bal_list_generic_get_int, i64(i8 addrspace(1)*, i64, i64)* @_bal_list_generic_set_int, i64(i8 addrspace(1)*, i64, i64)* @_bal_list_generic_inexact_set_int, double(i8 addrspace(1)*, i64)* @_bal_list_generic_get_float, i64(i8 addrspace(1)*, i64, double)* @_bal_list_generic_set_float, i64(i8 addrspace(1)*, i64, double)* @_bal_list_generic_inexact_set_float, i64 ptrtoint({i32, i32, [1 x %UniformSubtype*]}* @.member2 to i64), {i32}* null, [0 x i64] []}
...
@.member2 = internal constant {i32, i32, [1 x %UniformSubtype*]} {i32 0, i32 524288, [1 x %UniformSubtype*] [%UniformSubtype* bitcast(%Type3* @.subtype3 to %UniformSubtype*)]}
